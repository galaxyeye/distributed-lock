...
For more examples, take a look at `ai.platon.scent.lock.key.SpelKeyGeneratorTest`.
...
==== 1.2.0
- FEATURE: Added a JavaDoc description to `ai.platon.scent.lock.Lock.release()` method
- CHANGE: Rearranged the parameters of the `ai.platon.scent.lock.Lock.release()` method to be more consistent
- CHANGE: Rearranged the parameters of the `ai.platon.scent.lock.jdbc.service.JdbcLockSingleKeyService` methods to be more consistent
